...
enum ts_symbol_identifiers {
  ...
  anon_sym_version = 9,
  anon_sym_bundleID = 10,
  anon_sym_buildNumber = 11,
  anon_sym_imagePath = 12,
  anon_sym_launchSoundPath = 13,
  anon_sym_contentWarning = 14,
  anon_sym_contentWarning2 = 15,
  sym_string = 16,
  sym_integer = 17,
  sym_reverse_dns = 18,
  sym_pdxinfo = 19,
